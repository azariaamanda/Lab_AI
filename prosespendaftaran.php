...
$upload_directory = __DIR__ . "/uploads/magang/";
...
if (isset($_POST['submit_pendaftaran'])) {
    ...
    if ($result) {
        echo "<script>alert('Pendaftaran Magang berhasil dikirim!'); window.location='prosespendaftaran.php';</script>";
    } else {
...
<section class="main-content">
  <div class="form-container">
    ...
    <form method="POST" enctype="multipart/form-data">
      ...
      <div class="form-row">
        ...
        <div class="form-row">
          ...
          <div class="form-group file-upload">
            ...
            <input type="file" id="transkrip" name="transkrip" accept=".pdf,.doc,.docx">
            <label for="transkrip" class="file-label">Pilih File</label>
        ...
        <div class="form-row">
          <div class="form-group file-upload">
            <label>Surat Magang</label>
            <input type="file" id="surat" name="surat" accept=".pdf,.doc,.docx" required>
            <label for="surat" class="file-label">Pilih File</label>
            <div class="file-info">Format: PDF/DOC (Maks. 2MB)</div>
          </div>
          <div class="form-group file-upload">
      ...
      <button type="submit" name="submit_pendaftaran" class="btn-submit" style="margin-top: 20px;">Daftar Magang Laboratorium</button>
    </form>
